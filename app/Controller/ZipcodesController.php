...
class ZipcodesController extends AppController {
  ...
  public function getdata(){
    ...
    if($this->request->is('ajax')){
      ...
      $data = $this->Zipcode->find('all', array('conditions' => array('Zipcode.postal_code' => $this->request->data['zipcode'])));
      // $data = $this->Zipcode->find('all', array('conditions' => array('Zipcode.postal_code' => '9070000')));
      if (count($data)>1) {
