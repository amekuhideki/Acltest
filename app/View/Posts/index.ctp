...
<div class="posts index">
  ...
  <div id="carousel-example-generic" class="carousel slide top_carousel" data-ride="carousel">
    <!-- Indicators -->
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <?php echo $this->Html->image('/images/image.jpg', array('width' => '2000px')); ?>
        <div class="carousel-caption">
          ...
        </div>
      </div>
      <div class="item">
        <?php echo $this->Html->image('/images/image2.jpg', array('width' => '2000px')); ?>
        <div class="carousel-caption">
          ...
        </div>
      </div>
      <div class="item">
        <?php echo $this->Html->image('/images/image3.jpg', array('width' => '2000px')); ?>
        <div class="carousel-caption">
          ...
        </div>
      </div>
