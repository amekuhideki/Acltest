...
<div class="posts popular">
  ...
  <div class="main_sm">
    <div class="main_header_sm">
      <h4><?php echo (__('Popular articles list')); ?>
    </div>
        ...
        <?php foreach($posts as $post): ?>
          <div class="content_detail_sm">
            <?php if (!empty($post['Image'])): ?>
              <?php echo $this->Html->image('/files/image/attachment/' . $post['Image'][0]['dir'] . '/' . $post['Image'][0]['attachment'], array('width' => '26%')); ?>
            <?php else: ?>
              <?php echo $this->Html->image('/images/Noimage.jpg', array('class' => "con_image", 'width' => '26%')); ?>
            <?php endif; ?>
            ...
            <div class="post_content_sm">
              ...
              <div class="post_access_sm">
                <?php echo (__('訪問数') . ':'); ?>
                <?php echo $post['Post']['access_counter']; ?>
              </div>
